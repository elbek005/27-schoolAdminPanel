...
class TableAdapter(private var mTAbleList: List<TableData>, private val c: Context) :
    RecyclerView.Adapter<TableAdapter.TableViewHolder>() {


    inner class TableViewHolder(private var binding: RewTableClassBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TableViewHolder {
        val binding =
            RewTableClassBinding.inflate(LayoutInflater.from(parent.context), parent, false)
